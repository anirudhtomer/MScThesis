...
getEta=function(mcmcfit, summaryFuncName){
...
getRandMu=function(mcmcfit, summaryFuncName){
  summaryFunc = get(summaryFuncName)
  randmu=numeric()
...
getSigma=function(mcmcfit, summaryFuncName){
  summaryFunc = get(summaryFuncName)
  sigma = diag(10)
  for(i in 1:nrep){
    for(j in 1:nrep){
...
getOmega=function(mcmcfit, summaryFuncName){
  summaryFunc = get(summaryFuncName)
  omega = diag(10)
  for(i in 1:nrep){
    for(j in 1:nrep){
...
getXBeta=function(mcmcfit, summaryFuncName){
  summaryFunc = get(summaryFuncName)
