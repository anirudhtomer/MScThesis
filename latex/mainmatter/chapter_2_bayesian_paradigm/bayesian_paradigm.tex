...
\todo[inline]{I am not sure which ones I will end up using. Pretty confused what to write in this section. I've only used JAGS and WinBugs via R (hated WinBugs user interface)...tried SAS proc mcmc recently.}
