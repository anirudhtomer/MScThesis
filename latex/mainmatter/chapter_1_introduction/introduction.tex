...
is unbounded and has many spurious nodes \citep{kiefer_consistency_1956,day_estimating_1969}. A bayesian approach however, handles this problem more elegantly using priors for parameters ($\boldsymbol{\mu}, \boldsymbol{\sigma^2}$), as shown by \cite[pg. 176]{fruhwirth-schnatter_finite_2013}.
