...
\todo[inline]{Discuss this with Professor Lesaffre.}
For the DIC difference of 10 which is usually considered good enough to prefer one model over another, this rule may not be as applicable here. Could the reason be that that for chains with overfitted components in the mixture distribution we also get highly autocorrelated parameters despite a thinning of 1 per 200 iterations???\\
